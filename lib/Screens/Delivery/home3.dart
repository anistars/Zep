...
Future<Album> fetchAlbum() async {
  final response = await http.get('http://10.0.2.2:3000/display');
...
class WelcomeScreeen1 extends StatefulWidget {
  WelcomeScreeen1({Key key}) : super(key: key);
  @override
  _WelcomeScreeen1State createState() => _WelcomeScreeen1State();
}

class _WelcomeScreeen1State extends State<WelcomeScreeen1> {
  int _selectIndex = 0;
